...
const portfolio =[
  ...
  {id : 5 , img : '/assets/wedding.png' ,title : ' Wedding planner', details : [ {icon : <FaFileCode /> , title : 'Project : ' , desc : 'Wedding Services'},{icon : <FiUser /> , title : 'Practice : ' , desc : 'Project'},{icon : <FaCode  /> , title : 'Languages : ' , desc : 'Next js & tailwind '},{icon : <FiExternalLink/> , title : 'Preview : ' , desc : 'https://assignment02-gamma.vercel.app/'}],},
]
function Portfolio() {
  return (
