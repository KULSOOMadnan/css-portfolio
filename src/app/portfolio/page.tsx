...
const portfolio =[
  ...
  {id : 3 , img : '/assets/resume3.png' ,title : 'Resume Builder', details : [ {icon : <FaFileCode /> , title : 'Project : ' , desc : 'Static Resume'},{icon : <FiUser /> , title : 'Practice : ' , desc : 'Project'},{icon : <FaCode  /> , title : 'Languages : ' , desc : 'Html Css '},{icon : <FiExternalLink/> , title : 'Preview : ' , desc : 'https://resume-builder-by-kulsoom.vercel.app/'}],},
